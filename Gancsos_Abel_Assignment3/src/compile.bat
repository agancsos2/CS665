...
rmdir /S /Q %APP_ROOT%\..\bin\amgbattleship.dir
cd %APP_ROOT%\..\bin & %CMAKE_PATH%\cmake ..\
cd %APP_ROOT%\..\bin && %VS_PATH%\devenv.exe Gancsos_Abel_Assignment3.sln /build
rmdir /S /Q %APP_ROOT%\..\bin\amgbattleship.dir
...
xcopy /S /Q %APP_ROOT%\..\bin\Debug\amgbattleship.exe %APP_ROOT%\..\bin\
