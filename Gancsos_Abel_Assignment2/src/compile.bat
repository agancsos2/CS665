...
rmdir /S /Q %APP_ROOT%\..\bin\amgdeliverydispatch.dir
cd %APP_ROOT%\..\bin & %CMAKE_PATH%\cmake ..\
cd %APP_ROOT%\..\bin && %VS_PATH%\devenv.exe Gancsos_Abel_Assignment2.sln /build
rmdir /S /Q %APP_ROOT%\..\bin\amgdeliverydispatch.dir
...
xcopy /S /Q %APP_ROOT%\..\bin\Debug\amgdeliverydispatch.exe %APP_ROOT%\..\bin\
